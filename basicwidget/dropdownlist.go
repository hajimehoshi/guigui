...
func (d *DropdownList[T]) SetOnItemSelected(f func(context *guigui.Context, index int)) {
...
func (d *DropdownList[T]) Build(context *guigui.Context) error {
	...
	d.button.SetOnDown(func(context *guigui.Context) {
	...
	d.popupMenu.SetOnItemSelected(func(context *guigui.Context, index int) {
